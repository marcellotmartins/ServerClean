...
cls
netsh advfirewall firewall add rule name="80 TCP" dir=in action=allow protocol=TCP localport=40120
cls
netsh advfirewall firewall add rule name="80 UDP" dir=in action=allow protocol=UDP localport=40120
cls
netsh advfirewall firewall add rule name="80 TCP" dir=out action=allow protocol=TCP localport=40120
cls
netsh advfirewall firewall add rule name="80 UDP" dir=out action=allow protocol=UDP localport=40120
cls
netsh advfirewall firewall add rule name="80 TCP" dir=in action=allow protocol=TCP localport=30110
cls
netsh advfirewall firewall add rule name="80 UDP" dir=in action=allow protocol=UDP localport=30110
cls
netsh advfirewall firewall add rule name="80 TCP" dir=out action=allow protocol=TCP localport=30110
cls
netsh advfirewall firewall add rule name="80 UDP" dir=out action=allow protocol=UDP localport=30110
cls