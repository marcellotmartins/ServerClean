...
Ed.render = function(e, t, n, l, a, s) {
    ...
    }, [Pl("div", $d, [Pl("h1", jd, g(e.$filters.getNameByPhone(t.phone)), 1), t.message ? (wl(), _l("p", Fd, g(t.message.content || (t.message.image ? "ðŸ“· Foto" : "ðŸŒŽ Localização")), 1)) : (wl(), _l("p", zd, "Nenhuma mensagem..."))]), t.message ? (wl(), _l("p", Bd, g(e.$filters.unixToRelative(t.message.created_at)), 1)) : Ml("", !0)], 8, ["onClick"])))), 128))])])
};
const Hd = {
        setup() {
            jl("setDark")(_o.darkTheme.value);
...
tb.render = function(e, t, n, l, a, s) {
    ...
    return wl(), _l(o, {
        ...
        default: en((() => [Pl("ul", null, [(wl(!0), _l(bl, null, fa(l.groups, (t => (wl(), _l("li", {
            ...
            onClick: n => e.$router.push("/tor/" + t.id),
            class: "p-5 flex items-start text-white hover:bg-gray-900"
        }, [lb, Pl("div", ab, [Pl("div", sb, [Pl("h1", ob, "#" + g(t.id), 1), t.message ? (wl(), _l("h1", rb, g(e.$filters.unixToRelative(t.message.created_at)), 1)) : Ml("", !0)]), t.message ? (wl(), _l("p", ib, [t.message.location ? (wl(), _l("span", cb, "ðŸŒŽ Localização")) : t.message.image ? (wl(), _l("span", ub, "ðŸ“· Foto")) : (wl(), _l("span", db, g(t.message.content), 1))])) : (wl(), _l("p", pb, "Nenhuma mensagem..."))])], 8, ["onClick"])))), 128))]), Pl("button", {
            onClick: t[1] || (t[1] = (...e) => l.search && l.search(...e)),
            class: "absolute bottom-40 right-8 w-24 h-24 bg-tor text-white rounded-full"
        }, [fb])])),
        _: 1
...
py.render = function(e, t, n, l, a, s) {
    ...
    return wl(), _l("div", fy, [my, Pl("div", hy, [(null == (o = l.tweet) ? void 0 : o.id) ? (wl(), _l("div", by, [Pl("div", gy, [Pl("img", {
        ...
        key: 0,
        class: "ml-2 w-6 h-6"
    })) : Ml("", !0)]), Pl("h1", yy, "@" + g(l.tweet.author.username), 1)])]), Pl("p", ky, g(l.tweet.content), 1), Pl("p", wy, g(l.hour) + " Â· " + g(l.date) + " Â· Twitter for " + g(l.android ? "Kantroid" : "SmartPhone"), 1), Pl("div", Cy, [Pl("p", _y, [Pl("b", Ay, g(l.tweet.retweets), 1), Sy]), Pl("p", Ry, [Pl("b", Ty, g(l.tweet.likes), 1), Ey])])])) : Ml("", !0), Pl("div", Py, [Pl("button", {
...
const gw = {
    ...
    kw = Pl("h1", {
        class: "font-semibold"
    }, "Qual é o valor da transfêrencia?", -1),
    ww = {
        class: "mt-4 text-3xl"
    },
    ...
    Vw = Pl("h1", {
        class: "font-semibold"
    }, "Pronto, enviamos sua transfêrencia", -1),
    Dw = {
                            ...
                            if (jR.gender)
                                if (jR.tags)
                                    if (jR.target) {
                                        ...
                                        const e = n.target;
                                        if (!e) return l.value = "Escolha sua prefêrencia";
                                        jR.target = e
                                    }
                    else {
                        const e = [...n.tags];
...
CO.set("GPS", (({
    ...
    if (e != _o.identity.phone) {
        const s = Bs(e);
        let o = l ? "ðŸ“· Foto" : a ? "ðŸŒŽ Localização" : n;
    ...
    if ("geral" != e.channel && e.sender != zh.id && wO() !== "/tor/" + (t ? e.sender : e.channel)) {
        const n = e.location ? "ðŸŒŽ Localização" : e.image ? "ðŸ“· Foto" : e.content;
    ...
    if (null != e.created_at || (e.created_at = Math.floor(Date.now() / 1e3)), t in _o.messages ? _o.messages[t].push(e) > 100 && _o.messages[t].shift() : _o.messages[t] = [e], _o.hasNotificationFor("sms") && wO() != "/sms/" + t) {
        let e = n.substr(0, 40);
        n.length > 40 && (e += "..."), _o.addNotification("sms", Bs(t), l ? "ðŸ“· Foto" : a ? "ðŸŒŽ Localização" : e)
    }
}));
