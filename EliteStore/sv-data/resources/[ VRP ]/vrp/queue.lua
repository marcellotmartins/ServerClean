...
Config.Language = {
	joining = "[ ELITE STORE ] Entrando...",
	connecting = "[ ELITE STORE ] Conectando...",
	err = "[ ELITE STORE ] Não foi possível identificar sua steam ou Social Club.",
	_err = "[ ESTAMOS CRESCENDO ] Você foi desconectado por demorar demais na fila.",
	pos = "[ ELITE STORE ] Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[ ELITE STORE ] Não foi possível adiciona-lo na fila.",
    wlonly = "[ ELITE STORE ] Você não está aprovado na whitelist.",
	banned = "[ ELITE STORE ] Seu passaporte foi revogado na cidade.",
	steam = "[ ELITE STORE ] Você precisa estar com a steam aberta para conectar."
}
