...
function loadInt(coordsTable,table)
	...
	EnableInteriorProp(GetInteriorAtCoords(5.263491,6513.293,30.69846),"clotheslowhipster")
	EnableInteriorProp(GetInteriorAtCoords(1693.459,4823.674,40.88372),"clotheslowhipster")
	EnableInteriorProp(GetInteriorAtCoords(1195.758,2709.895,37.04323),"clotheslowhipster")
	EnableInteriorProp(GetInteriorAtCoords(-1101.907,2709.708,17.92847),"clotheslowhipster")
	EnableInteriorProp(GetInteriorAtCoords(-823.0248,-1074.298,10.14872),"clotheslowhipster")
	EnableInteriorProp(GetInteriorAtCoords(425.2449,-805.3314,28.31175),"clotheslowhipster")
	EnableInteriorProp(GetInteriorAtCoords(75.70789,-1393.818,28.19675),"clotheslowhipster")
