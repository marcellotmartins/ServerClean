...
cfg.GeneralConfig = {   
    ...
    locs = {
        {showBlip = true, coord = vector3(463.98266601562,-613.85363769531,27.499711990356), heading = 359.29, config = 'configBennys'},
        {showBlip = true, coord = vector3(-1284.9434814453,-2996.0649414062,-48.493995666504), heading = 359.29, config = 'configBennys'},
        {showBlip = true, coord = vector3(-1770.6381835938,70.379135131836,68.685119628906), heading = 359.29, config = 'configBennys'},
    },

    commands = {
        {showBlip = true, coord = vector3(-75.770088195801,-818.69323730469,326.17532348633), raio = 100000000, command = "openBennys", config = 'configBennys'},
    }
